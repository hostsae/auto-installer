...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/hostsae/debian7/sources.list.debian7"
...
# install openvpn
#wget -O /etc/openvpn/openvpn.tar "https://github.com/hostsae/debian7/raw/master/openvpn-debian.tar"
#cd /etc/openvpn/
#tar xf openvpn.tar
...
useradd -M -s /bin/false hostsae
echo "fornesia:$PASS" | indonesia
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/hostsae/debian7/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/hostsae/debian7/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/hotsae/debian7/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://github.com/hostsae/debian7/raw/master/go/dropbear-2014.63.tar.bz2
...
wget https://github.com/hostsae/debian7/raw/master/go/vnstat_php_frontend-1.5.1.tar.gz
...
# install pptp vpn
#wget https://raw.githubusercontent.com/hostsae/debian7/pptpinstall.sh
#chmod +x pptpinstall.sh
#./pptpinstall.sh

# download script
cd
wget -O speedtest.py "https://raw.githubusercontent.com/hostsae/debian7/speedtest.py"
wget -O bench-network.sh "https://raw.githubusercontent.com/hostsae/debian7/bench-network.sh"
wget -O ps_mem.py "https://raw.githubusercontent.com/hostsae/debian7/ps_mem.py"
wget -O dropmon "https://raw.githubusercontent.com/hostsae/debian7/dropmon.sh"
wget -O user-login.sh "https://raw.githubusercontent.com/hostsae/debian7/user-login.sh"
wget -O user-expired.sh "https://raw.githubusercontent.com/hostsae/debian7/user-expired.sh"
#wget -O userlimit.sh "https://raw.githubusercontent.com/hostsae/debian7/limit.sh"
wget -O user-list.sh "https://raw.githubusercontent.com/hostsae/debian7/user-list.sh"
wget -O /etc/issue.net "https://raw.githubusercontent.com/hostsae/debian7/master/banner%20login%20password"
...
echo "./speedtest.py --share (Speed Test VPS)"  | tee -a log-install.txt
